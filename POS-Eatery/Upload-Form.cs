                    ...
                    try
                    {
                        ...
                        if (daily_meter_reading.Checked == true)
                            ...
                            if (table_sales.Checked == true)
                            {
                                ...
                                gclass.display_in_dgv("SELECT* FROM table_sales_summary WHERE Day='" + date.Value.Day + "' AND Month='" + date.Value.Month + "' AND Year='" + date.Value.Year + "' and branch='"+ branch.Text +"'", dataGridView1);
                                ...
                                for (int i = 0; i < dataGridView1.Rows.Count; i++)
                                {
                                    ...
                                    try
                                    {
                                        MySqlConnection cn = new MySqlConnection(str200);
                                        cn.Open();
                                        string query = "INSERT INTO table_sales_summary(Product_Name,Quantity,Price,Item_Value,Amount_Paid,Balance,Date,Day,Month,Year,Employee,Short_Code,Minute,Second,Category,Code,Payment_Method,Customer_Name,Discount,Receipt_No,Cost,Branch)VALUES('" + dataGridView1.Rows[i].Cells[1].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[2].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[3].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[4].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[5].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[6].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[7].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[8].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[9].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[10].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[11].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[12].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[13].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[14].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[15].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[16].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[17].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[18].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[19].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[20].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[21].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[22].Value.ToString() + "') ON DUPLICATE KEY UPDATE product_name=values(product_name),quantity=values(quantity),price=values(price),item_value=values(item_value),amount_paid=values(amount_paid),balance=values(balance),date=values(date),day=values(day),month=values(month),year=values(year),employee=values(employee),short_code=values(short_code),minute=values(minute),second=values(second),category=values(category),code=values(code),payment_method=values(payment_method),customer_name=values(customer_name),discount=values(discount),Receipt_No=values(Receipt_No)";
                                        MySqlCommand cmd = new MySqlCommand(query, cn);
                                        cmd.ExecuteNonQuery();
                                        cn.Close();
                                    }
