...
namespace POS_Eatery
{
    public partial class Report_comp : Form
    {
        ...
        private void month_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            String cash1 = (Convert.ToDecimal(cash.Text) - Convert.ToDecimal(change.Text)).ToString();

            String cash2 = (Convert.ToDecimal(cash1) + Convert.ToDecimal(remit_cash.Text)).ToString();
            ...
            cash_at_hand.Text = (Convert.ToDecimal(cash2) - (Convert.ToDecimal(cash_to_bank.Text) + Convert.ToDecimal(expenses.Text))).ToString();
