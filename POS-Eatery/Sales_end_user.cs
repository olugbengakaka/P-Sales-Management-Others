            ...
            if (Convert.ToDecimal(quantity.Text) > 0 && Convert.ToDecimal(total.Text) > 0)
            {
                if (Convert.ToDecimal(discount1.Text) > 0)
                {
                    ...
                    else
                    {
                        ...
                        dataGridView2.Rows.Add(q2, productname1.Text, textBox7.Text, Math.Round(Convert.ToDecimal(total.Text)), discount1.Text, code.ToString() + abd.ToString(), cost.Text);
                        dataGridView1.Rows.Add(q1, "Discount", discount1.Text, "0");
                  ...
                  /*  if (payment_pos.Checked == true)
                    ...
                    try
                    {
                        ...
                        for (int w = 0; w < dataGridView2.Rows.Count; w++)
                        {
                            ...
                            MySqlCommand cmd1 = new MySqlCommand("INSERT INTO Table_Sales_confirmed(Product_Name,Category,Quantity,Price,Item_Value,Date,Day,Month,Year,Employee,Code,Payment_Method,Customer_Name,Discount,Receipt_No,Cost,Branch,phone)VALUES('" + dataGridView2.Rows[w].Cells[1].Value.ToString() + "','" + channel.Text + "','" + quantiti + "','" + desc + "','" + pris + "','" + date + "','" + s_day.Text + "','" + s_month.Text + "','" + s_year.Text + "','" + cashier_name.Text + "','" + code.ToString() + ast1.ToString() + "','" + payment_method.Text + "','" + company_name_search.Text + "','" + disco + "','" + invoice_number.Text + "','" + cos.ToString() + "','" + branch.Text + "','" + textBox3.Text + "')", cn);
                ...
                else
                {
                    try
                    {
                        ...
                        for (int w = 0; w < dataGridView2.Rows.Count; w++)
                        {
                            ...
                            MySqlCommand cmd1 = new MySqlCommand("INSERT INTO Table_Sales_confirmed(Product_Name,Category,Quantity,Price,Item_Value,Date,Day,Month,Year,Employee,Code,Payment_Method,Customer_Name,Discount,Receipt_No,Cost,Branch,phone)VALUES('" + dataGridView2.Rows[w].Cells[1].Value.ToString() + "','" + channel.Text + "','" + quantiti + "','" + desc + "','" + pris + "','" + date + "','" + s_day.Text + "','" + s_month.Text + "','" + s_year.Text + "','" + cashier_name.Text + "','" + code.ToString() + ast.ToString() + "','" + payment_method.Text + "','" + company_name_search.Text + "','" + disco + "','" + invoice_number.Text + "','" + cos.ToString() + "','" + branch.Text + "','" + textBox3.Text + "')", cn);
                            cmd1.ExecuteNonQuery();
